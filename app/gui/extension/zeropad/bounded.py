...
from app.network.extension.zeropad.bounded import ZeroPaddingBoundedExtension
...
class BoundedBoundaryStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ZeroPadBoundedParams(
                padding=self._padding.value
            ),
            options=ZeroPadBoundedOptions()
        )

    @property
    def default_params(self):
        return ZeroPaddingBoundedExtension.default_params()

    @property
    def default_options(self):
        return ZeroPaddingBoundedExtension.default_options()
        ...
        return (
            ...
            .append(
                ...
                .append(
                    ...
                    .weight(2)
                    .add(
                        Text(root, i18n("window.screens.network.extension.zeropad.bounded.labels.padding"))

...
from app.gui.neuron.constantpad3d.view import Boundary3dView, Boundary3dSwitcher


# Main

class NeuronBuilderConstantPadding3dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def __init__(self, dependencies):
        ...
        self._value = FormInput(self.default_params["value"])
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ConstantPad3dParams(
                value=self._value.value,
                **self.boundary_params.params
            ),
            options=ConstantPad3dOptions(
    ...
    def default_params(self):
        return ConstantPadding3d.default_params()

    @property
    def default_options(self):
        return ConstantPadding3d.default_options()

    def load(self, params, options):
        self._value.update(params["value"])
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderConstantPadding3dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderConstantPadding3dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad3d.labels.value"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)
                    ...
                    .add(
                        NumberInput(root, self._value.value)
                        .Bind(self._value)
            ...
            .append(
                ...
                .margin_vertical(LS.rem(.8))
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad3d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

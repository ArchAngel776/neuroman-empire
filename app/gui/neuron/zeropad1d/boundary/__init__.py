...
class UnboundedBoundaryStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ZeroPad1dBoundaryParams(
                padding=(
                    self._padding_left.value,
                    self._padding_right.value
                )
            ),
            options=ZeroPad1dBoundaryOptions()
        )
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.zeropad1d.boundaries.left"))
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.zeropad1d.labels.padding"))
                    )
                    .add(
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.zeropad1d.boundaries.right"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )

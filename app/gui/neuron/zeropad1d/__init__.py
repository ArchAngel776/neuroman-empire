...
from app.gui.neuron.zeropad1d.view import Boundary1dView, Boundary1dSwitcher


# Main

class NeuronBuilderZeroPadding1dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ZeroPad1dParams(
                **self.boundary_params.params
            ),
            options=ZeroPad1dOptions(
    ...
    def default_params(self):
        return ZeroPadding1d.default_params()

    @property
    def default_options(self):
        return ZeroPadding1d.default_options()
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderZeroPadding1dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderZeroPadding1dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.zeropad1d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

...
from app.gui.neuron.reflectionpad2d.view import Boundary2dView, Boundary2dSwitcher


# Main

class NeuronBuilderReflectionPadding2dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ReflectionPad2dParams(
                **self.boundary_params.params
            ),
            options=ReflectionPad2dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderReflectionPadding2dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderReflectionPadding2dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.reflectionpad2d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

...
class DoubleDimensionStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=AvgPool2dDimensionParams(
                kernel_size=(
            ...
            options=AvgPool2dDimensionOptions()
        )
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.avgpool2d.dimensions.height"))
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool2d.labels.kernel"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool2d.labels.stride"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool2d.labels.padding"))
                    )
                    .add(
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.avgpool2d.dimensions.width"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )

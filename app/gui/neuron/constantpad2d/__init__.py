...
from app.gui.neuron.constantpad2d.view import Boundary2dView, Boundary2dSwitcher


# Main

class NeuronBuilderConstantPadding2dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ConstantPad2dParams(
                value=self._value.value,
                **self.boundary_params.params
            ),
            options=ConstantPad2dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderConstantPadding2dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderConstantPadding2dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad2d.labels.value"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)
            ...
            .append(
                ...
                .margin_vertical(LS.rem(.8))
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad2d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

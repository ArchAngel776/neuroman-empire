...
class SingleDimensionStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=AdaptiveMaxPool1dDimensionParams(
                output_size=self._output_size.value
            ),
            options=AdaptiveMaxPool1dDimensionOptions()
        )
        ...
        return (
            ...
            .append(
                ...
                .append(
                    ...
                    .weight(2)
                    .add(
                        Text(root, i18n("window.screens.network.neurons.adaptivemaxpool1d.labels.output"))

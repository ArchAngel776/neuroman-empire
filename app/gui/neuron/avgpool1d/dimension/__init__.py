        ...
        return (
            ...
            .append(
                ...
                .append(
                    ...
                    .weight(2)
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool1d.labels.kernel"))
            ...
            .append(
                ...
                .append(
                    ...
                    .weight(2)
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool1d.labels.stride"))
                        .Align(Qt.AlignRight | Qt.AlignVCenter)
                    )
                )
                .append(
            ...
            .append(
                ...
                .append(
                    ...
                    .weight(2)
                    .add(
                        Text(root, i18n("window.screens.network.neurons.avgpool1d.labels.padding"))
                        .Align(Qt.AlignRight | Qt.AlignVCenter)
                    )
                )
                .append(

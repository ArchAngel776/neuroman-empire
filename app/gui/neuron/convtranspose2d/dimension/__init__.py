...
class DoubleDimensionStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ConvTranspose2dDimensionParams(
                kernel_size=(
            ...
            options=ConvTranspose2dDimensionOptions()
        )
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.convtranspose2d.dimensions.height"))
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose2d.labels.kernel"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose2d.labels.stride"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose2d.labels.padding"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose2d.labels.dilation"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose2d.labels.output_padding"))
                    )
                    .add(
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.convtranspose2d.dimensions.width"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )

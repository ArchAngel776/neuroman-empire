...
from app.gui.neuron.reflectionpad3d.view import Boundary3dView, Boundary3dSwitcher


# Main

class NeuronBuilderReflectionPadding3dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ReflectionPad3dParams(
                **self.boundary_params.params
            ),
            options=ReflectionPad3dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderReflectionPadding3dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderReflectionPadding3dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.reflectionpad3d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

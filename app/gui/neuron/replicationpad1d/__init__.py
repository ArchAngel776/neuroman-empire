...
from app.gui.neuron.replicationpad1d.view import Boundary1dView, Boundary1dSwitcher


# Main

class NeuronBuilderReplicationPadding1dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ReplicationPad1dParams(
                **self.boundary_params.params
            ),
            options=ReplicationPad1dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderReplicationPadding1dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderReplicationPadding1dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.replicationpad1d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

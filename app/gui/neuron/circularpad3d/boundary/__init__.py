...
class UnboundedBoundaryStrategy(NeuronStrategy):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=CircularPad3dBoundaryParams(
                padding=(
            ...
            options=CircularPad3dBoundaryOptions()
        )

    @property
    def default_params(self):
        return CircularPadding3d.default_params()

    @property
    def default_options(self):
        return CircularPadding3d.default_options()
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.left"))
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.circularpad3d.labels.padding"))
                    )
                    .add(
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.right"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.top"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.bottom"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.front"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.boundaries.back"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )

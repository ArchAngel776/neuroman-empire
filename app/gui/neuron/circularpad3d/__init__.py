...
from app.gui.neuron.circularpad3d.view import Boundary3dView, Boundary3dSwitcher


# Main

class NeuronBuilderCircularPadding3dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=CircularPad3dParams(
                **self.boundary_params.params
            ),
            options=CircularPad3dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderCircularPadding3dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderCircularPadding3dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad3d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

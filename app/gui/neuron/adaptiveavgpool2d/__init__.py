...
from app.gui.neuron.adaptiveavgpool2d.view import Dimension2dView, Dimension2dSwitcher


# Main

class NeuronBuilderAdaptiveAveragePooling2dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def change_dimension(self, event):
        self.make(
            NeuronBuilderAdaptiveAveragePooling2dStrategy.Watch.DIMENSION_SWITCHER,
    ...
    def dimension_switcher_program(self):
        return self.get(NeuronBuilderAdaptiveAveragePooling2dStrategy.Watch.DIMENSION_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.adaptiveavgpool2d.labels.square"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

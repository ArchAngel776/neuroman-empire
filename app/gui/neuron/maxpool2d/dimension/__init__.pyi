...
class DoubleDimensionStrategy(NeuronStrategy[MaxPool2dDimensionParams, MaxPool2dDimensionOptions]):
    class Dimension(int):
    ...
    @property
    def params(self) -> NeuronStrategyParams[MaxPool2dDimensionParams, MaxPool2dDimensionOptions]: ...

    @property
    def default_params(self) -> MaxPool2dDimensionParams: ...

    @property
    def default_options(self) -> MaxPool2dDimensionOptions: ...

    def load(self, params: MaxPool2dDimensionParams, options: MaxPool2dDimensionOptions) -> void: ...

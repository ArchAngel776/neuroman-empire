...
from app.gui.neuron.circularpad1d.view import Boundary1dView, Boundary1dSwitcher


# Main

class NeuronBuilderCircularPadding1dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=CircularPad1dParams(
                **self.boundary_params.params
            ),
            options=CircularPad1dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderCircularPadding1dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderCircularPadding1dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad1d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

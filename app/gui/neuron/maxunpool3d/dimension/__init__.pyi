...
class TripleDimensionStrategy(NeuronStrategy[MaxUnpool3dDimensionParams, MaxUnpool3dDimensionOptions]):
    class Dimension(int):
    ...
    @property
    def params(self) -> NeuronStrategyParams[MaxUnpool3dDimensionParams, MaxUnpool3dDimensionOptions]: ...

    @property
    def default_params(self) -> MaxUnpool3dDimensionParams: ...

    @property
    def default_options(self) -> MaxUnpool3dDimensionOptions: ...

    def load(self, params: MaxUnpool3dDimensionParams, options: MaxUnpool3dDimensionOptions) -> void: ...

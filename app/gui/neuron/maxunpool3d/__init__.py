...
class NeuronBuilderMaxUnpooling3dStrategy(NeuronStrategy):
    ...
    def select_indicated_pooling(neuron, index):
        return (
                neuron.type() in (NeuronType.MAXPOOL3D, NeuronType.FRACTIONALMAXPOOL3D, NeuronType.ADAPTIVEMAXPOOL3D)
                and
    ...
    def default_pool_layer_neuron(self):
        ...
        raise BrokenPipeError("Cannot detect any MaxPooling3D layer with enabled indices.")

...
from app.gui.neuron.replicationpad3d.view import Boundary3dView, Boundary3dSwitcher


# Main

class NeuronBuilderReplicationPadding3dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ReplicationPad3dParams(
                **self.boundary_params.params
            ),
            options=ReplicationPad3dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderReplicationPadding3dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderReplicationPadding3dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.replicationpad3d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

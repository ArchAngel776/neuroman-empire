...
from app.gui.neuron.circularpad2d.view import Boundary2dView, Boundary2dSwitcher


# Main

class NeuronBuilderCircularPadding2dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=CircularPad2dParams(
                **self.boundary_params.params
            ),
            options=CircularPad2dOptions(
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderCircularPadding2dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderCircularPadding2dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.circularpad2d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)

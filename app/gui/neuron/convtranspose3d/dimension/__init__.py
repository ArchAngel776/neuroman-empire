...
class TripleDimensionStrategy(NeuronStrategy):
    ...
    def __init__(self):
        ...
        self._output_padding_depth = FormInput(self.default_params["output_padding"][self.Dimension.DEPTH])
        ...
        self._output_padding_height = FormInput(self.default_params["output_padding"][self.Dimension.HEIGHT])
        ...
        self._output_padding_width = FormInput(self.default_params["output_padding"][self.Dimension.WIDTH])
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ConvTranspose3dDimensionParams(
                kernel_size=(
                ...
                output_padding=(
                    self._output_padding_depth.value,
                    self._output_padding_height.value,
                    self._output_padding_width.value
                )
            ),
            options=ConvTranspose3dDimensionOptions()
        )
    ...
    def load(self, params, options):
        ...
        self._output_padding_width.update(params["output_padding"][self.Dimension.DEPTH])
        ...
        self._output_padding_height.update(params["output_padding"][self.Dimension.HEIGHT])
        ...
        self._output_padding_width.update(params["output_padding"][self.Dimension.WIDTH])
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.convtranspose3d.dimensions.depth"))
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose3d.labels.kernel"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose3d.labels.stride"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose3d.labels.padding"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose3d.labels.dilation"))
                    )
                    .add(
                ...
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .add(
                        Text(root, i18n("window.screens.network.neurons.convtranspose3d.labels.output_padding"))
                    )
                    .add(
                        IntegerInput(root, self._output_padding_depth.value)
                        .Bind(self._output_padding_depth)
                        .Height(self._input_height)
                    )
                )
            )
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.convtranspose3d.dimensions.height"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
                ...
                .append(
                    ...
                    .add(
                        IntegerInput(root, self._output_padding_height.value)
                        .Bind(self._output_padding_height)
                        .Height(self._input_height)
                    )
                )
            )
            .append(
                ...
                .weight(1)
                .add(
                    Text(root, i18n("window.screens.network.neurons.convtranspose3d.dimensions.width"))
                    .Font(self._font_caption_title)
                    .Align(Qt.AlignCenter)
                    .Margin(0, LS.rem(.6))
                )
                ...
                .append(
                    ...
                    .add(
                        IntegerInput(root, self._output_padding_width.value)
                        .Bind(self._output_padding_width)
                        .Height(self._input_height)
                    )
                )
            )

...
class UnboundedBoundaryStrategy(NeuronStrategy[ZeroPad3dBoundaryParams, ZeroPad3dBoundaryOptions]):
    class Direction(int):
    ...
    @property
    def params(self) -> NeuronStrategyParams[ZeroPad3dBoundaryParams, ZeroPad3dBoundaryOptions]: ...

    @property
    def default_params(self) -> ZeroPad3dBoundaryParams: ...

    @property
    def default_options(self) -> ZeroPad3dBoundaryOptions: ...

    def load(self, params: ZeroPad3dBoundaryParams, options: ZeroPad3dBoundaryOptions) -> void: ...

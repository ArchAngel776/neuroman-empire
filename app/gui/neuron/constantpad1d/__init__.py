...
from app.gui.neuron.constantpad1d.view import Boundary1dView, Boundary1dSwitcher


# Main

class NeuronBuilderConstantPadding1dStrategy(NeuronStrategy):
    class Watch(str):
    ...
    def params(self):
        return NeuronStrategyParams(
            params=ConstantPad1dParams(
                value=self._value.value,
                **self.boundary_params.params
            ),
            options=ConstantPad1dOptions(
    ...
    def default_params(self):
        return ConstantPadding1d.default_params()

    @property
    def default_options(self):
        return ConstantPadding1d.default_options()
    ...
    def change_boundary(self, event):
        self.make(
            NeuronBuilderConstantPadding1dStrategy.Watch.BOUNDARY_SWITCHER,
    ...
    def boundary_switcher_program(self):
        return self.get(NeuronBuilderConstantPadding1dStrategy.Watch.BOUNDARY_SWITCHER).program
    ...
    def render(self, root):
        return (
            ...
            .append(
                ...
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad1d.labels.value"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)
            ...
            .append(
                ...
                .margin_vertical(LS.rem(.8))
                .add(
                    Text(root, i18n("window.screens.network.neurons.constantpad1d.labels.bounded"))
                )
                .append(
                    LayoutFactory(LayoutType.VERTICAL).create()
                    .align(Qt.AlignLeft)
